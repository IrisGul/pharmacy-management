...
const Register: React.FC = () => {
  ...
  const checkStrength = (password: string): string => {
    ...
    if (password.length < 4 || !hasUpper || !hasLower || !hasNumber) return "weak";
  ...
  return (
    <div className="register-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        />
        <small>
          Must be at least 4 characters, include uppercase, lowercase, and numbers.
        </small>
        {form.password && (
          <div className="strength-bar" style={{ backgroundColor: getStrengthColor() }}>
